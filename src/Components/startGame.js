...
const GameScreen = ({
  ...
  const checkAnswer = () => {
    ...
    const normalizedAltAnswer = currentData.correctAnswerAlt
      ? normalizeAnswer(currentData.correctAnswerAlt)
      : null;
    ...
    if (isAnswerCorrect) {
      ...
      if (newAttempts >= config.maxAttempts) {
        setFeedback(
          `❌ Sorry, that's incorrect. The answer was: ${currentData.correctAnswer}`
        );
        setShowCorrectVideo(true);
        setIsCorrect(false);
      } else {
  ...
  if (gameComplete) {
    return React.createElement(
      ...
      React.createElement(
        ...
        currentUser &&
          userProfile &&
          totalPointsAfterGame !== null &&
          React.createElement(
            "p",
            { className: "total-points" },
            `Total Points: ${totalPointsAfterGame}`
          ),
        React.createElement(
          "p",
          ...
          } questions with a maximum of ${getMaxPossiblePoints()} points`
        ),
        React.createElement(
          "div",
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          showHint &&
            React.createElement("span", { className: "hint-indicator" })
        ),
        ...
        (isCorrect || gaveUp || attempts >= config.maxAttempts) &&
          React.createElement(
            "button",
            {
